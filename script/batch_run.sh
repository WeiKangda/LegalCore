...
OUTPUT_PATH="${BASE_DIR}/output/${CURRENT_MONTH}/${CURRENT_DAY}/debug/"
...
# declare -a models=("Llama-3.1-8b-instruct" "QWen-14b" "Mistral-Nemo" "deepseek_llama-8b" "deepseek_Qwen-14b" "GPT-4-Turbo")
...
declare -a models=( "deepseek_Qwen-14b")

#  declare -a prompts=("zero_shot" "one_shot" "two_shot")
declare -a prompts=("two_shot")
